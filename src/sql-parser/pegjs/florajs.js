...
function peg$parse(input, options) {
  ...
  var peg$f2 = function(recursive, list) {
      return { type: 'with', recursive: recursive !== null, value: list };
    };
  var peg$f3 = function(head, tail) {
      return createList(head, tail);
    };
  var peg$f4 = function(name, columns, stmt) {
      return { name, stmt, columns };
    };
  var peg$f5 = function(head, tail) {
      return createList(head, tail);
    };
  var peg$f6 = function(cte, opts, d, c, f, w, g, h, o, l) {
      return {
        with: cte,
        type: 'select',
        options: opts,
  ...
  var peg$f8 = function(option) { return option; };
  var peg$f9 = function() { return '*'; };
  var peg$f10 = function(head, tail) {
      return createList(head, tail);
    };
  var peg$f11 = function(table) {
      return {
        expr: {
          type: 'column_ref',
          table,
  ...
  var peg$f12 = function(e, alias) {
      return { expr: e, as: alias };
    };
  var peg$f13 = function(i) { return i; };
  var peg$f14 = function(l) { return l; };
  var peg$f15 = function(head, tail) {
      return createList(head, tail);
    };
  var peg$f16 = function(t) { return t; };
  var peg$f17 = function(op, t, spec) {
      return { ...t, join: op, ...spec };
    };
  var peg$f18 = function() {
      return { type: 'dual' };
    };
  var peg$f19 = function(l, alias, cols) {
      return {
        expr: {
            type: 'values',
            value: l
  ...
  var peg$f20 = function(lateral, sub, alias, cols) {
      return {
        expr: { ...sub },
        as: alias,
  ...
  var peg$f21 = function(t, as) {
      return { ...t, as };
    };
  var peg$f22 = function() { return 'LEFT JOIN'; };
  var peg$f23 = function() { return 'RIGHT JOIN'; };
  var peg$f24 = function() { return 'FULL JOIN'; };
  var peg$f25 = function() { return 'INNER JOIN'; };
  ...
  var peg$f31 = function(rowkw, head, tail) {
      return {
        type: 'row_value',
        keyword: rowkw !== null,
  ...
  var peg$f33 = function(stmt) {
      return { ...stmt, parentheses: true };
    };
  var peg$f34 = function(head, tail) {
      return createList(head, tail);
    };
  var peg$f35 = function(e) { return e; };
  var peg$f36 = function(l) { return l; };
  var peg$f37 = function(head, tail) {
      return createList(head, tail);
    };
  var peg$f38 = function(e) { return e; };
  var peg$f39 = function(l) { return l; };
  var peg$f40 = function(head, tail) {
      return createList(head, tail);
    };
  var peg$f41 = function(e, d) {
    return { expr: e, type: d === 'DESC' ? 'DESC' : 'ASC' };
  };
  var peg$f42 = function(i1, tail) {
      var res = [i1];
      if (tail === null) res.unshift({ type: 'number', value: 0 });
      else res.push(tail[2]);
      return res;
    };
  var peg$f43 = function(t, l, w) {
      return {
        type: 'update',
        db: t.db,
        table: t.table,
  ...
  var peg$f45 = function(c, v) {
      return { column: c, value: v };
    };
  var peg$f46 = function(ri, t, c, v) {
      return {
        type: ri,
        db: t.db,
        table: t.table,
  ...
  var peg$f53 = function(expr, condition_list, otherwise) {
  ...
  var peg$f54 = function(condition, result) {
    return {
      type: 'when',
      cond: condition,
      result: result
  ...
  var peg$f59 = function(left, rh) {
      if (rh === null) return left;
      else if (rh.type === 'arithmetic') return createBinaryExprChain(left, rh.tail);
      else return createBinaryExpr(rh.op, left, rh.right);
    };
  var peg$f60 = function(op, sub) {
    return createUnaryExpr(op, { ...sub });
  };
  var peg$f61 = function(nk) { return nk[0] + ' ' + nk[2]; };
  var peg$f62 = function(l) {
      return { type: 'arithmetic', tail: l };
    };
  var peg$f63 = function(right) {
      return { op: 'IS', right };
    };
  var peg$f64 = function(right) {
      return { op: 'IS NOT', right };
  };
  var peg$f65 = function(op, begin, end) {
      return {
        op,
        right: {
          type: 'expr_list',
  ...
  var peg$f66 = function(nk) { return nk[0] + ' ' + nk[2]; };
  var peg$f67 = function(nk) { return nk[0] + ' ' + nk[2]; };
  var peg$f68 = function(nk) { return nk[0] + ' ' + nk[2]; };
  var peg$f69 = function(op, right) {
      return { op, right: right };
    };
  var peg$f70 = function(op, l) {
      return { op, right: l };
    };
  var peg$f71 = function(op, e) {
      return { op, right: e };
    };
  ...
  var peg$f79 = function(name) { return reservedMap[name.toUpperCase()] === true; };
  ...
  var peg$f83 = function(chars) { return chars.join(''); };
  var peg$f84 = function(chars) { return chars.join(''); };
  var peg$f85 = function(name) { return reservedMap[name.toUpperCase()] === true; };
  var peg$f86 = function(name) { return name; };
  var peg$f87 = function(start, parts) { return start + parts.join(''); };
  var peg$f88 = function(start, parts) { return start + parts.join(''); };
  var peg$f89 = function(l) {
      return { type: 'param', value: l[1] };
    };
  var peg$f90 = function(name, expr) {
      return { type: 'aggr_func', name, args: { expr } };
    };
  var peg$f91 = function(name, quantifier, expr) {
      return { type: 'aggr_func', name, quantifier, args: { expr } };
    };
  var peg$f92 = function() { return 'GROUP_CONCAT'; };
  var peg$f93 = function() { return { type: 'star', value: '*' }; };
  var peg$f94 = function(name, l) {
      return { type: 'function', name, args: l ? l : { type: 'expr_list', value: [] } };
    };
  var peg$f95 = function(name, l) {
      return { type: 'function', name, args: l ? l : { type: 'expr_list', value: [] } };
    };
  var peg$f96 = function(name) {
      return { type: 'function', name, args: { type: 'expr_list', value: [] } };
    };
  var peg$f97 = function(expr, target) {
    return { type: 'cast', expr, target };
  };
  var peg$f98 = function(e, precision) {
    return {
      type: 'cast',
      expr: e,
      target: {
  ...
  var peg$f99 = function(e, precision, scale) {
      return {
        type: 'cast',
        expr: e,
        target: {
  ...
  var peg$f100 = function(e, s, t) { /* MySQL cast to un-/signed integer */
    return {
      type: 'cast',
      expr: e,
      target: {
  ...
  var peg$f101 = function(sign, value, qualifier) {
  ...
  var peg$f106 = function(ca) {
      return {
        type: 'string',
        value: ca[1].join('')
      };
    };
  var peg$f107 = function(type, ca) {
      return {
  ...
  var peg$f112 = function() { return "\b"; };
  var peg$f113 = function() { return "\f"; };
  var peg$f114 = function() { return "\n"; };
  var peg$f115 = function() { return "\r"; };
  var peg$f116 = function() { return "\t"; };
  var peg$f117 = function() { return "\'"; };
  var peg$f118 = function(h1, h2, h3, h4) {
      return String.fromCharCode(parseInt("0x" + h1 + h2 + h3 + h4));
    };
  var peg$f119 = function(value) {
      return { type: 'number', value };
    };
  var peg$f120 = function(int_, frac, exp) { return parseFloat(int_ + frac + exp); };
  var peg$f121 = function(int_, frac) { return parseFloat(int_ + frac); };
  var peg$f122 = function(int_, exp) { return parseFloat(int_ + exp); };
  var peg$f123 = function(int_) { return parseFloat(int_); };
  var peg$f124 = function(op, digits) { return op + digits; };
  var peg$f125 = function(op, digit) { return op + digit; };
  var peg$f126 = function(digits) { return "." + digits; };
  var peg$f127 = function(e, digits) { return e + digits; };
  var peg$f128 = function(digits) { return digits.join(""); };
  var peg$f129 = function(e, sign) { return e + (sign !== null ? sign: ''); };
  var peg$f130 = function() { return 'ASC'; };
  var peg$f131 = function() { return 'DESC'; };
  var peg$f132 = function() { return 'ALL'; };
  var peg$f133 = function() { return 'DISTINCT';};
  var peg$f134 = function() { return 'BETWEEN'; };
  var peg$f135 = function() { return 'IN'; };
  var peg$f136 = function() { return 'IS'; };
  var peg$f137 = function() { return 'LIKE'; };
  var peg$f138 = function() { return 'EXISTS'; };
  var peg$f139 = function() { return 'NOT'; };
  var peg$f140 = function() { return 'AND'; };
  var peg$f141 = function() { return 'OR'; };
  var peg$f142 = function() { return 'COUNT'; };
  var peg$f143 = function() { return 'MAX'; };
  var peg$f144 = function() { return 'MIN'; };
  var peg$f145 = function() { return 'SUM'; };
  var peg$f146 = function() { return 'AVG'; };
  var peg$f147 = function() { return 'CHAR'; };
  var peg$f148 = function() { return 'VARCHAR';};
  var peg$f149 = function() { return 'NUMERIC'; };
  var peg$f150 = function() { return 'DECIMAL'; };
  var peg$f151 = function() { return 'SIGNED'; };
  var peg$f152 = function() { return 'UNSIGNED'; };
  var peg$f153 = function() { return 'INT'; };
  var peg$f154 = function() { return 'INTEGER'; };
  var peg$f155 = function() { return 'JSON'; };
  var peg$f156 = function() { return 'SMALLINT'; };
  var peg$f157 = function() { return 'DATE'; };
  var peg$f158 = function() { return 'TIME'; };
  var peg$f159 = function() { return 'TIMESTAMP'; };
  var peg$f160 = function() { return 'USER'; };
  var peg$f161 = function() { return 'INTERVAL'; };
  var peg$f162 = function() { return 'MINUTE'; };
  var peg$f163 = function() { return 'HOUR'; };
  var peg$f164 = function() { return 'DAY'; };
  var peg$f165 = function() { return 'MONTH'; };
  var peg$f166 = function() { return 'YEAR'; };
  var peg$f167 = function() { return 'CURRENT_DATE'; };
  var peg$f168 = function() { return 'CURRENT_TIME'; };
  var peg$f169 = function() { return 'CURRENT_TIMESTAMP'; };
  var peg$f170 = function() { return 'CURRENT_USER'; };
  var peg$f171 = function() { return 'SESSION_USER'; };
  var peg$f172 = function() { return 'SYSTEM_USER'; };
  var peg$f173 = function() { return 'ROW'; };
  var peg$f174 = function() { varList = []; return true; };
  var peg$f175 = function(s) {
      return { stmt: s, vars: varList };
    };
  var peg$f176 = function(va, e) {
    return {
      type: 'assign',
      left: va,
      right: e
  ...
  var peg$f177 = function(e) {
      return { type: 'return', expr: e };
    };
  var peg$f178 = function(head, tail) {
      return createBinaryExprChain(head, tail);
    };
  var peg$f179 = function(head, tail) {
      return createBinaryExprChain(head, tail);
    };
  var peg$f180 = function(lt, op, rt, expr) {
      return {
        type: 'join',
        ltable: lt,
        rtable: rt,
  ...
  var peg$f181 = function(e) {
      e.parentheses = true;
      return e;
    };
  var peg$f182 = function(name, l) {
  ...
  var peg$f185 = function(name, members) {
    //push for analysis
    varList.push(name);
  ...
  var peg$f187 = function(t, l) {
    return { dataType: t, length: parseInt(l.join(''), 10) };
  };
  var peg$f188 = function(t) { return { dataType: t }; };
  var peg$f189 = function(t) { return { dataType: t }; };
  var peg$f190 = function(t) { return { dataType: t }; };
  var peg$f191 = function(t) { return { dataType: t }; };
  var peg$f192 = function(t) { return { dataType: t }; };
  var peg$currPos = 0;
  var peg$savedPos = 0;
  ...
  function peg$parseselect_stmt_nake() {
    ...
    if (s3 !== peg$FAILED) {
      ...
      if (s9 !== peg$FAILED) {
        ...
        peg$savedPos = s0;
        s0 = peg$f6(s1, s5, s7, s9, s11, s13, s15, s17, s19, s21);
      } else {
        peg$currPos = s0;
        s0 = peg$FAILED;
      }
