...
export default class MySqlParserListener extends antlr4.tree.ParseTreeListener {
	...
	exitAlterByAddSpecialIndex(ctx) {
	}
	...
	exitHandlerConditionWarning(ctx) {
	}
	...
	enterNestedRowExpressionAtom(ctx) {
	}
